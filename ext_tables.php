...
if (!isset($GLOBALS['TCA']['tt_content']['ctrl']['type'])) {
    ...
    $tempColumns = [];
    $tempColumns[$GLOBALS['TCA']['tt_content']['ctrl']['type']] = [
        'exclude' => 1,
...
$GLOBALS['TCA']['tt_content']['columns'][$TCA['tt_content']['ctrl']['type']]['config']['items'][] = ['LLL:EXT:ttcontent_to_txnews/Resources/Private/Language/locallang_db.xlf:tt_content.tx_extbase_type.Tx_TtcontentToTxnews_TtContent', 'Tx_TtcontentToTxnews_TtContent'];
